...
namespace Skybound.Gecko
{
		...
		//nsIWindowProvider,
	{
        ...
        private BackgroundWorker dlHandler;
        ...
        public void Hack_GrabDL(string url)
        {
            durl = url;
            System.Threading.Thread newt = new System.Threading.Thread(gdl);
            newt.Start();
        }
        void gdl()
        {
            try
            {
                System.Net.WebRequest wr = System.Net.WebRequest.Create(durl);
        ...
        {
            this.dlHandler = new System.ComponentModel.BackgroundWorker();
            this.webBrowser1 = new System.Windows.Forms.WebBrowser();
            this.SuspendLayout();
            // 
            // dlHandler
            // 
            this.dlHandler.DoWork += new System.ComponentModel.DoWorkEventHandler(this.dlHandler_DoWork);
            // 
            // webBrowser1
            // 
		...
		#endregion
        public string bURL = "";
        private void dlHandler_DoWork(object sender, DoWorkEventArgs e)
        {
            System.Net.WebRequest wr = System.Net.WebRequest.Create(durl);
            if (wr.GetResponse().ContentType != "text/html" ||
                wr.GetResponse().ContentType != "text/plain" ||
